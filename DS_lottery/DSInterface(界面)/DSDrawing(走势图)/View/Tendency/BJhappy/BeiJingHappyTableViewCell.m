...
#import "Header.h"
@interface BeiJingHappyTableViewCell ()
{
...
@end
@implementation BeiJingHappyTableViewCell
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        for (int i = 1; i < 81; i++) {
            ...
            UILabel *numberLabel = [[UILabel alloc]initWithFrame:CGRectMake((i-1)*(cellHeight/2), 0, (cellHeight/2), cellHeight/2)];
