//
//  DSHomeLotteryAllTableViewCell.m
//  DS_lottery
//
...
@interface DSHomeLotteryAllTableViewCell()
...
///* 框里面的数字 */
//@property (strong, nonatomic) UILabel * text1;
//@property (strong, nonatomic) UILabel * text2;
//@property (strong, nonatomic) UILabel * text3;
//@property (strong, nonatomic) UILabel * text4;
//@property (strong, nonatomic) UILabel * text5;
//@property (strong, nonatomic) UILabel * text6;

@end

@implementation DSHomeLotteryAllTableViewCell
...
//    UIImageView * kuangImg = [[UIImageView alloc]init];
//    [kuangImg setImage:[UIImage imageNamed:@"ico-table"]];
//    [self.contentView addSubview:kuangImg];
//    [kuangImg mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.bottom.equalTo(line.mas_top).offset(-15);
//        make.width.equalTo(@(IOS_SiZESCALE(345)));
//        make.height.equalTo(@(41));
//        make.centerX.equalTo(@0);
//    }];

//    NSArray * titleAll = [NSArray arrayWithObjects:@"总和",@"前三",@"中三",@"后三",nil];
//    for (int i = 0; i < 4; i++) {
//        UILabel * title = [[UILabel alloc]init];
//        title.text = titleAll[i];
//        title.font = [UIFont systemFontOfSize:10];
//        title.textAlignment = NSTextAlignmentCenter;
//        title.textColor = COLORFontred;
//        [self.contentView addSubview:title];
//        [title mas_makeConstraints:^(MASConstraintMaker *make) {
//            make.left.equalTo(@((PhoneScreen_WIDTH - IOS_SiZESCALE(345))/2 + i*IOS_SiZESCALE(345)/4));
//            make.height.equalTo(@(IOS_SiZESCALE(20)));
//            make.top.equalTo(kuangImg.mas_top);
//            make.width.equalTo(@(IOS_SiZESCALE(345)/4));
//        }];
//    }

//    self.text1 = [[UILabel alloc]init];
//    self.text1.font = [UIFont systemFontOfSize:10];
//    self.text1.text = @"30";
//    self.text1.textAlignment = NSTextAlignmentCenter;
//    self.text1.textColor = COLORFont83;
//    [self.contentView addSubview:self.text1];
//    [self.text1 mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.left.equalTo(kuangImg.mas_left);
//        make.height.equalTo(@(IOS_SiZESCALE(20)));
//        make.top.equalTo(kuangImg.mas_top).offset(IOS_SiZESCALE(18));
//        make.width.equalTo(@(IOS_SiZESCALE(345)/4/3));
//    }];
//
//    self.text2 = [[UILabel alloc]init];
//    self.text2.font = [UIFont systemFontOfSize:10];
//    self.text2.text = @"和";
//    self.text2.textAlignment = NSTextAlignmentCenter;
//    self.text2.textColor = COLORFont83;
//    [self.contentView addSubview:self.text2];
//    [self.text2 mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.left.equalTo(self.text1.mas_right);
//        make.height.equalTo(@(IOS_SiZESCALE(20)));
//        make.top.equalTo(kuangImg.mas_top).offset(IOS_SiZESCALE(18));
//        make.width.equalTo(@(IOS_SiZESCALE(345)/4/3));
//    }];
//
//    self.text3 = [[UILabel alloc]init];
//    self.text3.font = [UIFont systemFontOfSize:10];
//    self.text3.text = @"双";
//    self.text3.textAlignment = NSTextAlignmentCenter;
//    self.text3.textColor = COLORFont83;
//    [self.contentView addSubview:self.text3];
//    [self.text3 mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.left.equalTo(self.text2.mas_right);
//        make.height.equalTo(@(IOS_SiZESCALE(20)));
//        make.top.equalTo(kuangImg.mas_top).offset(IOS_SiZESCALE(18));
//        make.width.equalTo(@(IOS_SiZESCALE(345)/4/3));
//    }];
//
//    self.text4 = [[UILabel alloc]init];
//    self.text4.font = [UIFont systemFontOfSize:10];
//    self.text4.text = @"双";
//    self.text4.textAlignment = NSTextAlignmentCenter;
//    self.text4.textColor = COLORFont83;
...
//    }];
//
//    self.text5 = [[UILabel alloc]init];
//    self.text5.font = [UIFont systemFontOfSize:10];
//    self.text5.text = @"双";
//    self.text5.textAlignment = NSTextAlignmentCenter;
//    self.text5.textColor = COLORFont83;
//    [self.contentView addSubview:self.text5];
//    [self.text5 mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.left.equalTo(self.text4.mas_right);
//        make.height.equalTo(@(IOS_SiZESCALE(20)));
//        make.top.equalTo(kuangImg.mas_top).offset(IOS_SiZESCALE(18));
//        make.width.equalTo(@(IOS_SiZESCALE(345)/4));
//    }];
//
//    self.text6 = [[UILabel alloc]init];
//    self.text6.font = [UIFont systemFontOfSize:10];
//    self.text6.text = @"双";
//    self.text6.textAlignment = NSTextAlignmentCenter;
//    self.text6.textColor = COLORFont83;
//    [self.contentView addSubview:self.text6];
//    [self.text6 mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.left.equalTo(self.text5.mas_right);
//        make.height.equalTo(@(IOS_SiZESCALE(20)));
//        make.top.equalTo(kuangImg.mas_top).offset(IOS_SiZESCALE(18));
//        make.width.equalTo(@(IOS_SiZESCALE(345)/4));
//    }];
...
-(void)setModel:(DSOpenAwardModel *)model{
    ...
    for (int i = 0; i < arrays.count; i++) {
        ...
        all+= [arrays[i]integerValue];
    }


    for (int i = 0; i < 4; i++) {
        UILabel * label = [[UILabel alloc]initWithFrame:CGRectMake(left, 0, IOS_SiZESCALE(25), IOS_SiZESCALE(25))];
        label.textColor = COLORFont121;
        label.font = [UIFont systemFontOfSize:10];
        label.textAlignment = NSTextAlignmentCenter;
        label.layer.cornerRadius = 5;
        label.layer.borderWidth = 1;
        label.layer.borderColor = COLORLine.CGColor;
        [self.numberBack addSubview:label];
        ...
        switch (i) {
            ...
            case 2:
                ...
                break;
            case 3:
                if([arrays[0]integerValue] == [arrays[4]integerValue]){
                    label.text= @"和";
                }else if([arrays[0]integerValue] > [arrays[4]integerValue]){
                    label.text= @"龙";
                }else{
                    label.text= @"虎";
                }
    ...
    //和双大龙
//    self.text1.text = [NSString stringWithFormat:@"%ld",all];
//    if([arrays[0]integerValue] == [arrays[4]integerValue]){
//         self.text2.text= @"和";
//    }else if([arrays[0]integerValue] > [arrays[4]integerValue]){
//         self.text2.text= @"龙";
